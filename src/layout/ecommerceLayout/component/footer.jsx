        ...
        <>
            <footer className="footer p-10 bg-base-200 text-base-content">
                ...
                <div className="items-center grid-flow-col">
                    ...
                    <p>Koala Creative Indonesia. <br/>Copyright © 2023</p>
                </div> 
                <div className="md:place-self-center md:justify-self-end">
                    <div className="grid grid-flow-col gap-4">
                        <a href=""><InstagramOutlined className="text-3xl text-pink-600" /></a>
                        <a href=""><YoutubeOutlined className="text-3xl text-red-600" /></a>
                        <a href=""><FacebookOutlined className="text-3xl text-blue-600" /></a>
                    </div>
                </div>
            </footer>
        </>
